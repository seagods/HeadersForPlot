...
float RedLslide[maxlights][Lprops],GreenLslide[maxlights][Lprops]
       ,BlueLslide[maxlights][Lprops],AlphaLslide[maxlights][Lprops];

float RedL[maxlights][Lprops],GreenL[maxlights][Lprops]
...
float RedMslide[imats][Mprops],GreenMslide[imats][Mprops]
       ,BlueMslide[imats][Mprops],AlphaMslide[imats][Mprops]
       ,ShineMslide[imats][Mprops];

float RedPC1slide[imats][Mprops],GreenPC1slide[imats][Mprops]
       ,BluePC1slide[imats][Mprops];

float RedM[imats][Mprops],GreenM[imats][Mprops]
       ,BlueM[imats][Mprops],AlphaM[imats][Mprops],ShineM[imats][Mprops];

float RedPC1[imats][Mprops],GreenPC1[imats][Mprops]
