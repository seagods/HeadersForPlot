...
#include "/usr/local/include/qtheaders/qchar.h"
#include "/usr/local/include/qtheaders/qbytearray.h"
#include "/usr/local/include/qtheaders/qatomic.h"
#include "/usr/local/include/qtheaders/qnamespace.h"
#ifdef QT_INCLUDE_COMPAT
#include "/usr/local/include/qtheaders/q3cstring.h"
#endif
...
#if defined(QT_USE_FAST_OPERATOR_PLUS) || defined(QT_USE_QSTRINGBUILDER)
#include "/usr/local/include/qtheaders/qstringbuilder.h"
#endif
