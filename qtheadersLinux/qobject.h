...
#include "/usr/local/include/qtheaders/qobjectdefs.h"
#include "/usr/local/include/qtheaders/qstring.h"
#include "/usr/local/include/qtheaders/qbytearray.h"
#include "/usr/local/include/qtheaders/qlist.h"
#ifdef QT_INCLUDE_COMPAT
#include "/usr/local/include/qtheaders/qcoreevent.h"
#endif
#include "/usr/local/include/qtheaders/qscopedpointer.h"
