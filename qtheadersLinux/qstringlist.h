...
#include "/usr/local/include/qtheaders/qalgorithms.h"
#include "/usr/local/include/qtheaders/qdatastream.h"
#include "/usr/local/include/qtheaders/qlist.h"
#include "/usr/local/include/qtheaders/qregexp.h"
#include "/usr/local/include/qtheaders/qstring.h"
#include "/usr/local/include/qtheaders/qstringmatcher.h"
#ifdef QT_INCLUDE_COMPAT
#include "/usr/local/include/qtheaders/q3valuelist.h"
#endif
